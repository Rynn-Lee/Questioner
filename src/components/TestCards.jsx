...
const TestCards = (props) => {
  return(
    <div className="questions-card">
      ...
      {!props.mytest && <div><span className="theme"><i className="fa-solid fa-graduation-cap"></i> User - </span> {props.user}</div>}
      {(!props.mytest && props.group) && <div><span className="theme"><i className="fa-solid fa-users-rectangle"></i> Group - </span> {props.group}</div>}
